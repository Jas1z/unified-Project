...
export function StatCard({ title, value, icon: Icon, color, subtitle }: StatCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-subtle p-4 sm:p-5 flex items-start justify-between card-hover">
      ...
      <div className={`p-2 sm:p-2.5 rounded-xl ${color.replace('600', '50').replace('500', '50')} ${iconColor} flex-shrink-0`}>
