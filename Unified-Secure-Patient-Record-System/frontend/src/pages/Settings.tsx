  ...
  return (
    <div className="page-stack max-w-4xl">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 sm:gap-x-8">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <button type="button" onClick={handleRotate} disabled={rotating} className="touch-target flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-900 text-white font-medium px-5 py-3 rounded-xl text-sm transition-colors disabled:opacity-70 w-full sm:w-auto">
